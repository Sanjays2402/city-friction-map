...
const en = {
  ...
  card: {
    ...
    distanceM: "{n} m",
    distanceKm: "{n} km",
    stepFreeTitle: "Affects step-free access",
    stillThere: "Still there?",
    stillThereTitle: "Confirm with one tap that this is still a problem",
  },
  map: {
  ...
  detail: {
    ...
    stepFree: "♿ Blocks step-free access",
  ...
  dialogs: {
    report: {
      ...
      stepFree: "This blocks step-free access (wheelchair, stroller)",
      hereLocation: "Current location ({lat}, {lng})",
  ...
  toasts: {
    ...
    outsideCity:
      "You're outside {city}. Move the map or pick a spot inside the city.",
...
const es = {
  ...
  card: {
    ...
    distanceM: "{n} m",
    distanceKm: "{n} km",
    stepFreeTitle: "Afecta el acceso sin escalones",
    stillThere: "¿Sigue ahí?",
    stillThereTitle: "Confirma con un toque que esto sigue siendo un problema",
  },
  map: {
  ...
  controls: {
    ...
    stepFreeOnly: "♿ Problemas de acceso",
  ...
  detail: {
    ...
    stepFree: "♿ Bloquea el acceso sin escalones",
  ...
  dialogs: {
    report: {
      ...
      stepFree:
        "Esto bloquea el acceso sin escalones (silla de ruedas, carriola)",
      hereLocation: "Ubicación actual ({lat}, {lng})",
  ...
  toasts: {
    ...
    outsideCity:
      "Estás fuera de {city}. Mueve el mapa o elige un punto dentro de la ciudad.",
